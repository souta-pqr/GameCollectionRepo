...
function startNumberGame() {
  numberToGuess = Math.floor(Math.random() * 100) + 1; // 数当てゲームの答えをリセット
  lastGuess = null; // 前回の予想をリセット
  remainingGuesses = 10; // 数当てゲームの制限回数をリセット
  document.getElementById("history").innerHTML = "前回の予想: なし"; // 前回の予想をリセット
  document.getElementById("remaining").innerHTML = "残り回数: " + remainingGuesses; // 残り回数をリセット
